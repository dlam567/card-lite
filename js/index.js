(function(){
    ...
    function addListeners() {
        if(textFormed) {
            ...
            if(txt) {
                flag ++;
                    createText(txt.toUpperCase());
                if (flag<2){
                    setTimeout(addListeners, 1100);
                    txt = name
                }else if(flag===2){
                    setTimeout(function (){loading.in("main.html?"+'nickname='+name)},1700);
                }
    ...
    function createText(t) {
        ...
        if (fontSize > 145) fontSize = 145;
        text.text = t;
        text.font = "600 "+fontSize+"px 'Source Sans Pro'";
        text.textAlign = 'center';
        text.x = 300;
        text.y = (172-fontSize)/3;
